    ...
    <div className={STAFF_PAGE_STACK}>
      <div>
        ...
        <p className="page-subtitle">
          Platform investment plan catalog — ROI, duration, and limits.
        </p>
      </div>
      <SupportReadOnlyBanner>
        Catalog view only. Support cannot create or modify investment plans.
      </SupportReadOnlyBanner>
      <InvestmentPlansPanel apiBase="/support-team" readOnly />
    </div>
  );
}
